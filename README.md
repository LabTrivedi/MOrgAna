...
The MOrgAna software has been tested with Python 3.7, 3.8, 3.9. To install Python, we recommend using the  [Miniforge distribution](https://github.com/conda-forge/miniforge). 
